...
t.add("site.data.get_sms_code_btn", "Get SMS verification code", "js", "en");
...
t.add("site.data.get_sms_code_allowance_success_hint", "\u53d1\u9001\u77ed\u4fe1\u6210\u529f,\u8fd8\u6709%allowance%\u6b21\u53d1\u9001\u673a\u4f1a", "js", "en");
...
t.add("user.settings.login_password_success", "\u8bbe\u7f6e\u767b\u5f55\u5bc6\u7801\u6210\u529f", "js", "en");
t.add("material.share.teacher_nickname_label", "Please input teacher nickname", "js", "en");
t.add("user.settings.unbind_success", "\u53d6\u6d88\u7ed1\u5b9a\u6210\u529f", "js", "en");
t.add("user.settings.unbind_title", "\u53d6\u6d88\u7ed1\u5b9a", "js", "en");
t.add("user.settings.unbind_content", "\u786e\u5b9a\u8981\u53d6\u6d88\u7ed1\u5b9a\u5417\uff1f", "js", "en");
...
t.add("uploader.size_2m_limit_hint", "\u6587\u4ef6\u8fc7\u5927\uff0c\u8bf7\u4e0a\u4f20\u5c0f\u4e8e2M\u7684\u6587\u4ef6\uff01", "js", "en");
...
t.add("importer.import_verify_tips_start", "\u6821\u9a8c\u6210\u529f\uff01\u4e00\u5171\u5305\u542b", "js", "en");
t.add("importer.import_verify_tips_end", "\u6761\u6570\u636e", "js", "en");
t.add("importer.import_back_btn", "\u8fd4\u56de", "js", "en");
t.add("importer.import_reselect_btn", "\u91cd\u65b0\u5bfc\u5165", "js", "en");
t.add("importer.import_confirm_btn", "\u786e\u5b9a\u5bfc\u5165", "js", "en");
t.add("importer.import_error", "\u5bfc\u5165\u51fa\u9519", "js", "en");
t.add("importer.import_progress_data", "\u5df2\u7ecf\u5bfc\u5165%number%\u6761\u6570\u636e", "js", "en");
t.add("importer.import_finish_data", "\u5bfc\u5165\u6210\u529f, \u603b\u5171\u5bfc\u5165%number%\u6761\u6570\u636e", "js", "en");
...
t.add("activity.download_manage.materials_or_link_error_hint", "\u8bf7\u5148\u4e0a\u4f20\u6587\u4ef6\u6216\u6dfb\u52a0\u8d44\u6599\u7f51\u7edc\u94fe\u63a5", "js", "en");
t.add("activity.download_manage.materials_or_link_fail", "\u8d44\u6599\u6dfb\u52a0\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5", "js", "en");
t.add("activity.download_manage.materials_or_link_success", "\u8d44\u6599\u6dfb\u52a0\u6210\u529f", "js", "en");
t.add("activity.download_manage.materials_or_link_delete", "\u8d44\u6599\u5df2\u5220\u9664", "js", "en");
t.add("activity.download_manage.materials_or_link_confirm_delete", "\u771f\u7684\u8981\u5220\u9664\u8be5\u8d44\u6599\u5417\uff1f", "js", "en");
...
t.add("classroom_manage.student_manage_remove_assistant_hint", "%username%\u662f\u73ed\u7ea7\u7684\u52a9\u6559\uff0c\u8bf7\u5148\u53d6\u6d88Ta\u7684\u52a9\u6559\u6743\u9650", "js", "en");
...
t.add("course.manage.live_replay_generate_error", "\u672a\u5f00\u542f\u76f4\u64ad\u56de\u653e\u6216\u89c6\u9891\u6b63\u5728\u8f6c\u7801\u4e2d\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5", "js", "en");
...
t.add("confirm.warn", "\u8b66\u544a", "js", "en");
t.add("confirm.exit.tip", "\u60a8\u786e\u5b9a\u8981\u9000\u51fa\u5b66\u4e60\u5417\uff1f", "js", "en");
...
t.add("oauth.send.validate_message", "\u53d1\u9001\u9a8c\u8bc1", "js", "en");
t.add("oauth.send.error_message_tip", "\u8bf7\u6c42\u53d1\u9001\u6b21\u6570\u8fc7\u591a\uff0c\u8bf7\u7a0d\u540e\u5c1d\u8bd5", "js", "en");
t.add("oauth.send.sms_code_error_tip", "\u60a8\u8f93\u5165\u7684\u77ed\u4fe1\u9a8c\u8bc1\u7801\u4e0d\u6b63\u786e", "js", "en");
t.add("oauth.refresh.captcha_code_tip", "\u56fe\u5f62\u9a8c\u8bc1\u7801\u5df2\u5931\u6548\uff0c\u8bf7\u91cd\u65b0\u8f93\u5165\u56fe\u5f62\u9a8c\u8bc1\u7801", "js", "en");
...
t.add("admin.user.statistics.data.learn_total_time", "\u5b66\u4e60\u603b\u65f6\u957f", "js", "en");
t.add("admin.user.statistics.data.learn_time", "\u5b66\u4e60\u65f6\u957f\/\u5206\u949f", "js", "en");
t.add("admin.user.statistics.data.time", "\u65f6\u957f", "js", "en");
t.add("course.audio.enable.biz.user", "\u542c\u8bfe\u6a21\u5f0f\u9700\u8981\u5148\u7533\u8bf7\u4e3a\u5546\u4e1a\u7528\u6237!", "js", "en");
t.add("admin.data.lab.setting.error", "\u53d1\u751f\u5f02\u5e38\u4e86\uff0c\u8bf7\u91cd\u8bd5\uff01", "js", "en");
