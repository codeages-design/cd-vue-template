export default {
  "site.flash_not_install_hint":`Flash player is not installed in your browser or version is too low, please install the Flash player. <a target="_blank" href="http://www.adobe.com/go/getflashplayer"> Click Install</a>`,
  ...
  "activity.audio_manage.length_required_error_hint":"Please enter the durations",
  ...
  "Activity.homework_manage.objective_question_hint":`This is an objective question, when the correct rate is <input type="text" name="passedCondition[]" class="form-control width-input width-input-mini ph5 text-center correctPercent1" value="60" />%Pass, <input type="text" name="passedCondition[]" class="form-control width-input width-input-mini ph5 text-center correctPercent2" value="80" />%Good, <input type="text" name="passedCondition[]" class="form-control width-input width-input-mini ph5 text-center correctPercent3" value="100" />%Excellent`,
  "activity.homework_manage.pass_objective_question_hint":`This is a testpaper with objective question. If the mark reached <input type="text" name="passedScore" class="form-control width-150 mhs" value = "0" data-score-total = "0" /> or above, can be automatically reviewed as pass the exam.`,
  ...
  "course_set.manage.activity_link_hint":`<p class = "title"> Tasks </p>When designing learning tasks, you can add preview, learning, practice, assingment, extracurricular activities to lessons.`,

  "course_set.manage.upgrade_hint":`<p class = "title"> Feature Upgrade </p> The course management feature is now updated.`,

  "course_set.manage.all_tutorial":`<div class = "btn-content"> <p> <a class='btn btn-success js-reset-intro %introBtnClassName%'> view the </a> </ p> <a class = 'btn btn- Info '> complete tutorial </a> <div>`,

  "course_set.manage.hint":`<p class = "title"> Multiple programs </p> Congratulations for creating multiple programs! The function menu on the left side will be simplified and only the relevant settings for the course will be displayed.`,

  "course_set.manage.upgrade_step1_hint":`<p class = "title"> Scheduled Tasks </p> To edit and manage the teaching content, please click "Tasks".`,

  "course_set.manage.upgrade_step2_hint":`<p class = "title"> Marketing Settings </p> In the "Marketing Settings" you can determine how the course is sold, how to join, and how to learn.`,

  "course_set.manage.upgrade_step3_hint":`<p class = "title"> Add tasks </p> Here you can choose a variety of teaching methods, and then upload the file / set the content / set the learning completion conditions.`,

  "course_set.manage.upgrade_step5_hint":`<p class = "title"> Tasks </p>When desinging learning tasks, you can add preview, learning, practice, assingment, extracurricular activities to lessons.`,
  ...
  "meterial_lib.confirm_share_resource_hint":"Sure you want to share this resource",
  ...
  "share.wechat_share_usage_hint":`Open the WeChat, click "discovery" on the bottom, <br> "scan" to share the page to the moment.`,
  ...
  "validate.unsigned_integer.message":"Please enter a non-negative integer",
  
  "validate.second_range.message":"Please enter a number between 0-59",
  ...
  "notify.order_cancel_succeed.message":"The order has been canceled successfully",
  ...
  "validate_old.visible_character.message":"%display% Enter the visibility character",
  ...
  "cashier.confirm.desc":"Please re-open the page to complete the order payment.<br>If you encounter problems in the payment process, please contact the website customer service solution.<br>",
